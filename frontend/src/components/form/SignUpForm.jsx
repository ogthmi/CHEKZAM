        ...
        <Container className="justify-content-center mt-5">
            ...
            <Row className="justify-content-center">
                <Col md={8} lg={6} className="px-5">
                    <CustomAlert message={message} error={error}/>
                    <Form onSubmit={handleSignUp}>
                        ...
                        <Row className="mb-1">
                            <Col>
                                ...
                                <Form.Check inline label="Nam" type="radio" name="gender" value="male" checked={formData.gender === "male".toUpperCase()} onChange={handleChange} />
                                <Form.Check inline label="Nữ" type="radio" name="gender" value="female" checked={formData.gender === "female".toUpperCase()} onChange={handleChange} />
                            </Col>
                        </Row>
                        ...
                        <Row>
                            <Col className="mb-2">
                                ...
                                <Form.Check inline label="Giáo viên" type="radio" name="role" value="teacher" checked={formData.role === "teacher".toUpperCase()} onChange={handleChange} />
                                <Form.Check inline label="Sinh viên" type="radio" name="role" value="student" checked={formData.role === "student".toUpperCase()} onChange={handleChange} />
                            </Col>
                        </Row>
                    ...
                    <Row>
                        <Col className="py-2 text-center">
                            <p>Đã có tài khoản? <Link to={SUB_ENDPOINTS.auth.signin} className="text-primary">Đăng nhập</Link></p>
                        </Col>
                    </Row>
                </Col>
            </Row>
