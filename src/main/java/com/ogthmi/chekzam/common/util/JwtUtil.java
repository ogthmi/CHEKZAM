...
import com.ogthmi.chekzam.module.auth.InvalidatedTokenEntity;
...
import com.ogthmi.chekzam.module.auth.InvalidatedTokenRepository;
...
public class JwtUtil {
    ...
    public String buildScope(UserEntity userEntity){
