...
public class SubmissionController {
    ...
    @PostMapping("/start")
    public ApiResponse<SubmissionResponse> startAssignment (@RequestBody SubmissionRequest submissionRequest){
        return ApiResponse.success(
                submissionService.startSubmission(submissionRequest),
    ...
    public ApiResponse<SubmissionResponse> submitAssignment (@RequestBody SubmissionRequest submissionRequest){
        return ApiResponse.success(
                submissionService.createSubmissionAndAnswer(submissionRequest),
                SuccessMessageCode.CREATED_SUCCESSFULLY
        );
    }
