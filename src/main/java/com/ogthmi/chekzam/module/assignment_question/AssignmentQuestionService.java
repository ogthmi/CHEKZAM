...
public class AssignmentQuestionService {
    ...
    public void updateAssignmentQuestions(List<QuestionDTO<AnswerDTO>> updatedQuestions) {
        for (QuestionDTO<AnswerDTO> questionDTO : updatedQuestions) {
            questionService.updateQuestionWithAnswer(questionDTO);
        }
    }
